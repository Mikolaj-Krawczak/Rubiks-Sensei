...
frontend_datas = []
frontend_dirs = ['pages', 'components', 'assets', 'css']
...
# Node modules - Electron binaries (tylko niezbędne)
node_modules_path = app_path / 'node_modules'
if node_modules_path.exists():
    # Electron binary - różne ścieżki dla różnych systemów
    electron_paths = []
...
exe = EXE(
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=True,  # Pokaż konsolę dla debugowania, można zmienić na False
