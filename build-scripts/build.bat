...
:: Przejdź do katalogu głównego (jeden poziom wyżej)
cd /d "%~dp0.."

:: Sprawdź czy jesteśmy w odpowiednim katalogu
if not exist "build-scripts\launcher.py" (
    echo ❌ Błąd: Nie znaleziono build-scripts\launcher.py. Upewnij się że jesteś w katalogu głównym aplikacji.
    exit /b 1
)
